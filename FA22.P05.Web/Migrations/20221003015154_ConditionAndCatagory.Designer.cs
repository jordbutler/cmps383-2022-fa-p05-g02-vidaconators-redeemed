...
namespace FA22.P05.Web.Migrations
{
    ...
    [Migration("20221003015154_ConditionAndCatagory")]
    partial class ConditionAndCatagory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FA22.P05.Web.Features.Authorization.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FA22.P05.Web.Features.Authorization.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FA22.P05.Web.Features.Authorization.UserRole", b =>
                {
            ...
            modelBuilder.Entity("FA22.P05.Web.Features.Authorization.UserRole", b =>
                {
                    b.HasOne("FA22.P05.Web.Features.Authorization.Role", "Role")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("FA22.P05.Web.Features.Items.Item", b =>
                {
                    b.HasOne("FA22.P05.Web.Features.Authorization.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("FA22.P05.Web.Features.Authorization.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("FA22.P05.Web.Features.Authorization.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
